      ...
      <div className="mx-auto grid w-11/12 max-w-7xl grid-cols-1 items-center gap-7 md:grid-cols-2 md:gap-12">
        <div className="min-w-0 space-y-4 text-left sm:space-y-6">
          ...
          <div className="flex flex-wrap items-center gap-3 pt-1 sm:gap-4 sm:pt-2">
            <button className="rounded-lg bg-gradient-to-r from-orange-500 via-pink-600 to-purple-600 px-4 py-2.5 text-sm font-medium text-white shadow-md transition-all duration-200 hover:opacity-95 sm:px-6 sm:py-3">
              Explore Technologies
            </button>

            <button className="rounded-lg border border-gray-200 px-4 py-2.5 text-sm font-medium text-gray-700 transition-all duration-200 hover:border-gray-400 hover:text-gray-900 sm:px-6 sm:py-3">
              Learn More
            </button>
          </div>
        </div>
